...
/**
 * @typedef {Object} GradualBlurProps
 * @property {'top'|'bottom'|'left'|'right'} [position]
 * @property {number} [strength]
 * @property {string} [height]
 * @property {number} [divCount]
 * @property {boolean} [exponential]
 * @property {number} [zIndex]
 * @property {false|'scroll'} [animated]
 * @property {string} [duration]
 * @property {string} [easing]
 * @property {number} [opacity]
 * @property {'linear'|'bezier'|'ease-in'|'ease-out'|'ease-in-out'} [curve]
 * @property {boolean} [responsive]
 * @property {'parent'|'page'} [target]
